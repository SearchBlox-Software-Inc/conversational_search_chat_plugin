...
function PluginSettings() {
   ...
   const chatAvailable =  CHATBOT_CONFIG_VALID || currentParameters.cname || currentParameters.botname;
                           ...
                           <span className={styles.switchContainer}>
                              <Switch
                                 ...
                                 onChange={(e) => {
                                    ...
                                    setLLMFieldsMode("replace"); // remove this line and the below commented code if you want to show both options
                                 }}
                                 sx={MUI_SWITCH_STYLES}
                              />
                           </span>
