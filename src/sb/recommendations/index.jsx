...
import ContentTypeIcons from '../searchResults/ContentTypeIcons';
                                       ...
                                       <div className={styles.colnameText}>
                                          {
                                             result.colname ?
                                                <div className={styles.detail} title="Collection">
                                                   <ContentTypeIcons type={result.contenttype || null} />
                                          ...
                                          {
                                             <span className={styles.resultcount}>{index + 1}</span>
                                          }
                                       </div>
                                    </div>
                                 </div>
